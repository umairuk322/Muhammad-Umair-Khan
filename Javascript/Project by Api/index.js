...
function getAllProducts() {
  let mappedProducts = data.products.map((meriProduct)=>{
    return `<div class="product">
        ...
        <h4>${meriProduct.category}</h4>
            ...
            <p class="product-desc">${meriProduct.description}</p>
...
// }function getFragrancesProducts() {
//   let filteredProducts = data.products.filter((meriProduct)=>{
//     return meriProduct.category === 'fragrances';
//   })
//   let mappedProducts = filteredProducts.map((meriProduct)=>{
//     return `<div class="product">
//                   <img
...
// }function getFurnitureProducts() {
//   let filteredProducts = data.products.filter((meriProduct)=>{
//     return meriProduct.category === 'furniture';
//   })
//   let mappedProducts = filteredProducts.map((meriProduct)=>{
//     return `<div class="product">
//                   <img
...
// }function getGroceriesProducts() {
//   let filteredProducts = data.products.filter((meriProduct)=>{
//     return meriProduct.category === 'groceries';
//   })
//   let mappedProducts = filteredProducts.map((meriProduct)=>{
//     return `<div class="product">
//                   <img
